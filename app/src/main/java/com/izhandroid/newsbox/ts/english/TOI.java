...
private InterstitialAd mInterstitialAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isConnected(TOI.this))
            buildDialog(TOI.this).show();
        else {
...
//TODO adid
    ...
    public void LoadWeb() {
        ...
        if(intent!= null) {
            ...
            if (data != null && data.containsKey("nga")) {
            ...
            if (data != null && data.containsKey("ngb")) {
                ...
                wv.loadUrl(urla);
                Bundle params = new Bundle();
                params.putString("msg", "Financial Ex loaded from HansAct");
                params.putString("title", "ngb was called");
                firebaseAnalytics.logEvent("FinExEn", params);
            }
            if (data != null && data.containsKey("ngc")) {
                urla = data.getString("ngc");
                wv.loadUrl(urla);
                Bundle params = new Bundle();
            ...
            switch (keyCode) {
                case KeyEvent.KEYCODE_BACK:
                    if (wv.canGoBack()) {
                        ...
                        wv.goBack();
                        Snackbar snacki = Snackbar.make(wv, "Press Again", Snackbar.LENGTH_SHORT);
                        snacki.show();
